...
public:
  ...
  void analysisCB(motion_common::forwardGoalConstPtr goal_)
  {
    int loop_rate = 10;
...
void callback_pid(motion_forward::pidConfig &config, double level)
{
...
void callback_ip(const std_msgs::Float32MultiArray::ConstPtr& msg)
{
  if(!data_received)
  {
